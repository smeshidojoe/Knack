...
GitHub, нет ли версии новее. Найденную предлагает карточкой в панели: «Обновить»
ставит сразу, «Позже» откладывает эту версию и больше о ней не напоминает.
Проверку можно выключить в настройках.

Пункт «Проверить обновление» в меню трея делает то же самое по требованию и
ставит найденное без вопросов.
