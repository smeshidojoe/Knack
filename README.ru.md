...
уходят, а ползунок громкости двигает громкость именно этого приложения, а не
всей системы.

Под обложкой — громкость, тот же уровень, что и у системного ползунка в трее. Клик или протяжка по полосе, колесо над ней двигает по 5%, клик по
