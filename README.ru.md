...
Скриншоты из буфера падают сюда сами, файлы можно бросить мышью: тащишь файл
на панель с любой вкладки — полка открывается сама. Клик кладёт
...
Пустые задачи убираются сами при уходе с вкладки.
